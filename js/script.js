...
jQuery(window).load(function () {
  ...
  $(".teaserTitle ")
    .stop()
    .animate({ marginTop: "330px", opacity: "1" }, 1000, "easeOutQuint");
  $(".shortcat a ")
    .stop()
    .animate({ marginTop: "65px", opacity: "1" }, 600, "easeOutQuint");
});
...
$(document).ready(function () {
  ...
  sections.waypoint({
    handler: function (event, direction) {
      ...
      var active_link = $(
        '#mainNav a[href="#' + active_section.attr("id") + '"]'
      );
  ...
  $("#submit").click(function () {
    ...
    $("input#contactNumber").removeClass("errorForm");
    $("input#email").removeClass("errorForm");
    $(".validationError").css("display", "none");

    var error = false;
    var contactValidationError = false;
